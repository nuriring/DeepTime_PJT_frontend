...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      numOfPages() {
        return Math.ceil(this.category1Articles.length / this.dataPerPage);
      },
      calData() {
        return this.category1Articles.slice(this.startOffset, this.endOffset)
      }
    },
    ...
    created() {
      ...
      this.listData = this.category1Articles
