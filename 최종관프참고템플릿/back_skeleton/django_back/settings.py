...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'rest_framework.authtoken',  # token 기반 auth가능
    # DRF auth
...
MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', #CORS -> CommonMiddleware 보다 위에 위치
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        'rest_framework.authentication.TokenAuthentication', #token auth만 쓸거임
    ],
